...
export const ArtistEnded = (props) => {
        ...
        <div>
          <div className="flex">
            ...
            <div className="flex flex-col items-center md:ml-20 grow">
              ...
              <p
                style={{ width: 500 }}
                className="mt-4 text-s	text-center softPink"
              >
                Thanks for your participation, we hope you enjoyed the game!
                Congratulations to all prize winners; the wavWRLD team will
                reach out to you shortly. Stay connected and join our community
                on Telegram below.
              </p>
              <a
