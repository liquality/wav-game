...
export const GameTabs = (props: GameTabsProps) => {
  ...
  const levelStatus = {
    ...
    2: currentLevel > 2 ? 'completed' : currentLevel === 2 ? 'active' : currentLevel === 1 ? 'upcomming' : 'locked',
    3: currentLevel > 3 ? 'completed' : currentLevel === 3 ? 'active' : currentLevel === 2 ? 'upcomming' : 'locked',
    4: currentLevel > 4 ? 'completed' : currentLevel === 4 ? 'active' : currentLevel === 3 ? 'upcomming' : 'locked',
    5: currentLevel > 5 ? 'completed' : currentLevel === 5 ? 'active' : currentLevel === 4 ? 'upcomming' : 'locked',
    6: currentLevel === 6 ? 'active' : currentLevel === 5 ? 'upcomming' : 'locked',
  };
